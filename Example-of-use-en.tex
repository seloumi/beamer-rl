...
\title{\textdir TLT {\bfseries beamer-rl} class}

\author{\textdir TLT Salim Bou}
...
\date{{\selectlanguage{english}v2.1 - 06/11/2026}}
...
Creating beamer presentation for languages with script from right to left   (like arabic) using \hologo{pdfLaTeX} or \hologo{XeLaTeX} still poses some problems due to bugs not currently resolved especially for colors.
