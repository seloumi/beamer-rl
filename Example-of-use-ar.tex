...
انشاء عرض بيمر عربي (اتجاه النص من اليمين لليسار) اعتمادا على 
 ...
 مازال يعترضه بعض المشاكل والمعوقات مثل ما يتعلق بالألوان والروابط والتي لم يوجد لها حلولا~بعد. 
...
هذه الفئة (class) تعدل في بعض أوامر وتعليمات beamer لغرض انشاء عروض من اليمين إلى اليسار (العربية على سبيل المثال)، الفئة تستدعي \verb|babel| ضمنيا مع الخيار \verb|bidi=basic| والمعالجة تتطلب استخدام 
\hologo{LuaLaTeX} 
...
\begin{block}{أورستد}
  لاحظ هانز أورستد في 21 أبريل 1820 وهو يُعد احدى التجارب أن إبرة
